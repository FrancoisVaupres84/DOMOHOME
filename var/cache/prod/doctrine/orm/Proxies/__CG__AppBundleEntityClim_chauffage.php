 ...
 */
class Clim_chauffage extends \AppBundle\Entity\Clim_chauffage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Clim_chauffage' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Clim_chauffage' . "\0" . 'mode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Clim_chauffage $proxy) {
