...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\ModeDeleteType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ModeDeleteType']) ? $this->services['AppBundle\\Form\\ModeDeleteType'] : ($this->services['AppBundle\\Form\\ModeDeleteType'] = new \AppBundle\Form\ModeDeleteType())) && false ?: '_'};
}, 'AppBundle\\Form\\ModeType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ModeType']) ? $this->services['AppBundle\\Form\\ModeType'] : ($this->services['AppBundle\\Form\\ModeType'] = new \AppBundle\Form\ModeType())) && false ?: '_'};
}, 'AppBundle\\Form\\ScenarioDeleteType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ScenarioDeleteType']) ? $this->services['AppBundle\\Form\\ScenarioDeleteType'] : ($this->services['AppBundle\\Form\\ScenarioDeleteType'] = new \AppBundle\Form\ScenarioDeleteType())) && false ?: '_'};
}, 'AppBundle\\Form\\ScenarioType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ScenarioType']) ? $this->services['AppBundle\\Form\\ScenarioType'] : ($this->services['AppBundle\\Form\\ScenarioType'] = new \AppBundle\Form\ScenarioType())) && false ?: '_'};
